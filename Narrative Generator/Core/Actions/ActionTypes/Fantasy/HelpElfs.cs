...
{
    /// <summary>
    /// The class that implements the agent's action: "Help Elfs"
    /// </summary>
    [Serializable]
    class HelpElfs : PlanAction
    {
        /// <summary>
        ...
        public HelpElfs (WorldDynamic state) { DefineDescription(state); }

        /// <summary>
        /// Constructor for the action instance.
        /// </summary>
        /// <param name="args">The arguments to be passed to the action.</param>
        public HelpElfs (params Object[] args) : base(args) { }
        ...
        public HelpElfs (ref KeyValuePair<AgentStateStatic, AgentStateDynamic> agent,
