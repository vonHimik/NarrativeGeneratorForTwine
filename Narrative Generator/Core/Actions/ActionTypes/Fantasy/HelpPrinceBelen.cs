...
{
    /// <summary>
    /// The class that implements the agent's action: "Help Prince Belen"
    /// </summary>
    [Serializable]
    class HelpPrinceBelen : PlanAction
    {
        /// <summary>
        ...
        public HelpPrinceBelen (WorldDynamic state) { DefineDescription(state); }

        /// <summary>
        /// Constructor for the action instance.
        /// </summary>
        /// <param name="args">The arguments to be passed to the action.</param>
        public HelpPrinceBelen (params Object[] args) : base(args) { }
        ...
        public HelpPrinceBelen (ref KeyValuePair<AgentStateStatic, AgentStateDynamic> agent,
